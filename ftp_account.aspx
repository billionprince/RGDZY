<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ftp_account.aspx.cs" Inherits="RGDZY.ftp_account" %>
...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>FTP Account List</div>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<div class="modal-header">
										...
										<h3 id="myModalLabel1">FTP Account Edit</h3>

									</div>

									<div class="modal-body">

										<form id="ftp_form" action="#" class="form-horizontal">

                                            <label id ="ftpedit" style="display:none"></label>
                                            ...
                                            <div class="control-group">
		    									...
		    									<input id ="ftppassword" type="text" class="medium m-wrap" style="margin: 0 auto;" data-provide="typeahead" data-items="4">
                                                    <ul class="typeahead dropdown-menu" style="top: 531px; left: 436px; display: none;">
                                                        <li data-value="Colorado" class="active"><a href="#">Color<strong>ad</strong>o</a></li>
                                                        <li data-value="Nevada"><a href="#">Nev<strong>ad</strong>a</a></li>
	...
	<script src="media/js/ftp.js"></script>
	<script>
