<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lab_member.aspx.cs" Inherits="RGDZY.lab_member" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">Lab Members</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Member List</div>
								<div class="tools">
