<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="RGDZY.control.Header" %>
...
<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="default.aspx"><img src="media/image/logo.png" alt="logo"/></a>
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="data/login.ashx?command=get_logout"><i class="icon-key"></i> Log Out</a></li>
